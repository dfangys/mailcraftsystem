...
class EnvConfig {
  ...
  /// IMAP host
  static String get imapHost =>
      dotenv.env['IMAP_HOST'] ?? 'wbmail.wahdabank.com.ly';

  /// IMAP port
  static int get imapPort =>
      int.tryParse(dotenv.env['IMAP_PORT'] ?? '43245') ?? 43245;
  ...
  static String get smtpHost =>
      dotenv.env['SMTP_HOST'] ?? 'wbmail.wahdabank.com.ly';

  /// SMTP port
  static int get smtpPort =>
      int.tryParse(dotenv.env['SMTP_PORT'] ?? '43244') ?? 43244;
