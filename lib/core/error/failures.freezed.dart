...
/// @nodoc
abstract class _$$MailFailureImplCopyWith<$Res>
    implements $FailureCopyWith<$Res> {
  factory _$$MailFailureImplCopyWith(
          _$MailFailureImpl value, $Res Function(_$MailFailureImpl) then) =
      __$$MailFailureImplCopyWithImpl<$Res>;
  @override
  @useResult
...
/// @nodoc
class __$$MailFailureImplCopyWithImpl<$Res>
    extends _$FailureCopyWithImpl<$Res, _$MailFailureImpl>
    implements _$$MailFailureImplCopyWith<$Res> {
  __$$MailFailureImplCopyWithImpl(
      _$MailFailureImpl _value, $Res Function(_$MailFailureImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$MailFailureImpl(
      message: null == message
          ? _value.message
          : message // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$MailFailureImpl implements MailFailure {
  const _$MailFailureImpl({required this.message, this.details});
  ...
  @override
  String toString() {
    return 'Failure.mail(message: $message, details: $details)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$MailFailureImplCopyWith<_$MailFailureImpl> get copyWith =>
      __$$MailFailureImplCopyWithImpl<_$MailFailureImpl>(this, _$identity);
...
abstract class MailFailure implements Failure {
  const factory MailFailure(
      {required final String message,
      final String? details}) = _$MailFailureImpl;
