...
class _$MessageAddressImpl implements _MessageAddress {
  const _$MessageAddressImpl({required this.email, this.name});
  ...
  @override
  String toString() {
    return 'MessageAddress(email: $email, name: $name)';
  }
...
abstract class _MessageAddress implements MessageAddress {
  const factory _MessageAddress(
      {required final String email, final String? name}) = _$MessageAddressImpl;
