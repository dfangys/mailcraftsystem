...
class MockMessageRepository implements MessageRepository {
  ...
  Future<Either<Failure, List<Message>>> getMessages(
      String accountId, String mailboxPath,
      {int? limit, int? offset, dynamic sortOrder}) async {
    ...
    return Right(List.generate(
        ...
        (index) => Message(
            ...
            subject: 'Mock Email $index')));
  }

  @override
  Future<Either<Failure, Message>> getMessage(
      String accountId, String mailboxPath, int uid) async {
    await Future.delayed(const Duration(seconds: 1));
    return Right(Message(
        id: '$uid',
        uid: uid,
        mailboxPath: mailboxPath,
        subject: 'Mock Email $uid'));
  }
  ...
  @override
  Future<Either<Failure, void>> moveMessage(String accountId,
      String fromMailboxPath, String toMailboxPath, int uid) async {
    await Future.delayed(const Duration(seconds: 1));
    return const Right(null);
  }

  @override
  Future<Either<Failure, void>> copyMessage(String accountId,
      String fromMailboxPath, String toMailboxPath, int uid) async {
    await Future.delayed(const Duration(seconds: 1));
    return const Right(null);
  }
  ...
  Future<Either<Failure, void>> deleteMessage(
      String accountId, String mailboxPath, int uid,
  ...
  @override
  Future<Either<Failure, String>> downloadAttachment(String accountId,
      String mailboxPath, int uid, String attachmentId) async {
    await Future.delayed(const Duration(seconds: 1));
  ...
  Future<Either<Failure, List<Message>>> searchMessages(
      String accountId, String mailboxPath, dynamic criteria) async {
    await Future.delayed(const Duration(seconds: 1));
    return const Right([]);
  }
  ...
  Future<Either<Failure, List<Message>>> getMessageThread(
      String accountId, String messageId) async {
    await Future.delayed(const Duration(seconds: 1));
    return const Right([]);
  }
  ...
  Future<Either<Failure, void>> bulkMarkAsRead(
      String accountId, String mailboxPath, List<int> uids) async {
    await Future.delayed(const Duration(seconds: 1));
    return const Right(null);
  }
  ...
  @override
  Future<Either<Failure, void>> bulkMove(String accountId,
      String fromMailboxPath, String toMailboxPath, List<int> uids) async {
    await Future.delayed(const Duration(seconds: 1));
    return const Right(null);
  }
  ...
  Future<Either<Failure, void>> bulkDelete(
      String accountId, String mailboxPath, List<int> uids,
      {bool permanent = false}) async {
    await Future.delayed(const Duration(seconds: 1));
    return const Right(null);
  }
